...
const OTNote = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8 flex flex-col items-center gap-8 print:p-0 print:bg-white print:gap-0 print:block">
      ...
      <div className="w-[210mm] h-[297mm] bg-white shadow-xl p-8 relative print:shadow-none print:w-[210mm] print:h-[297mm] print:p-8 text-black print:mb-0 overflow-hidden box-border">
